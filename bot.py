...
# -*- coding: utf-8 -*-
"""
🤖 Almasi Traid v177 - PRO & X-RAY DEBUG Edition
"""
...
# ============================================================================
# EXCHANGE INTERFACE (WITH X-RAY BALANCE SCANNER)
# ============================================================================
class Exchange:
    def __init__(self):
        ...
        try:
            ...
            log.error("❌ Auth Error: کلیدهای API اشتباه است یا آی‌پی وایت‌لیست نشده است.")
    ...
    def bal(self):
        ...
        try:
            ...
            # --- سیستم X-RAY: چاپ دیتای مخفی صرافی در لاگ ---
            ...
            log.error("❌ Balance Error: API Permission denied. تیک Contract/Trade را روشن کنید.")
            return 0.0
        except Exception as e: 
...
# ============================================================================
# INDICATORS & DATABASE & TG & STRATEGY & ENGINE & FLASK
# ============================================================================
class Indicators:
    @staticmethod
    def rsi(close, n=14):
