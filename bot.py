...
class Exchange:
    ...
    def _connect(self):
        ...
        try:
            ...
            log.info("✅ اتصال واقعی به Phemex Testnet برقرار شد.")
        except Exception as e:
        ...
        for sym in SYMBOLS:
            try:
                ...
                if output.action in ("buy", "sell"):
                    ...
                    if qty > 0:
                        self._open_position(sym, output, round(qty, 2))
            except Exception as e:
