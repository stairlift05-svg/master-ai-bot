...
# Default strategy parameter sets (stop/target multiples of ATR).
...
class Settings:
    ...
    trend_strength_threshold: float = 0.01  # percent
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            entry_cooldown_s=_env_float("ENTRY_COOLDOWN", 240, 0, 86400),
